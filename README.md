...
L'état initial d'un morpion sera communiqué sur une ligne de caractère
qui dictera l'état du morpion en allant de gauche à droite et de haut en bas.
...
Serveur :                                             Client (avec X pour le num du client) :
srv_systm_attentejoueur1                              cltX_systm_connexion 
srv_systm_attentejoueur2                              

srv_morpi_initmorpion                                 cltX_morpi_morpioninitialise
srv_morpi_checketatmorpion                            cltX_morpi_etatmorpion_XXXXXXXX (voir au dessus pour l'explications des XXXXXXXXX)
srv_morpi_resyncmorpion_XXXXXXXXX                     cltX_morpi_resychronise

srv_morpi_attactionj1                                 cltX_morpi_dessiner_LC (Ligne Collonne)
srv_morpi_attactionj2                                 cltX_morpi_dessinercroix_LC
